...
const Header = () => {
  ...
  return (
    <Flex
      ...
      // pr={200}
      p={4}
      pl={[0, 0, 10, 20]} // Responsive padding: 0px on mobile, 200px on desktop
      pr={[0, 0, 10, 20]} // Responsive padding: 0px on mobile, 200px on desktop
      height="100px"
      align="center"
            ...
            <DrawerContent>
              ...
              <DrawerBody>
                ...
                <VStack align='left' fontFamily='sans-serif' spacing={4}>
                  ...
                  <Divider />
                  <Text><Link to="/inquiries">Inquiries</Link></Text>
                  <Divider />
